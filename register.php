                        ...
                        <div class="register_left_form">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="field-name" value="" placeholder="Fist Name">
                                </div>

                                <!--Form Group-->
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">

                                    <input type="text" name="field-name" value="" placeholder="Lat Name">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="field-name" value="" placeholder="Address">
                                </div>
